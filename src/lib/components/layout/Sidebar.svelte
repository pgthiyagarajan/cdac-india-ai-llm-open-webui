				...
				>
					...
					>
						<div class=" self-center flex items-center justify-center size-9">
							<!-- <img
								src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcToQKNJWOuOCro-RtXQjwJCZxuSagXV-G7ZTg&s"
	...
	>
		...
		>
			...
			<div class="px-1.5 pt-1.5 pb-2 sticky bottom-0 z-10 -mt-3 sidebar">
				...
				></div>
				<div class="flex justify-start pl-1.5 pb-1.5">
					<img src="/open-webui-logo.png" alt="open-webui-logo" class="w-7 rounded-full" />
				</div>
